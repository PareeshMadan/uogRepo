...
int runSimulation(struct TokenRingData *simulationData, int numPackets, pthread_t *thrd);
int cleanupSystem(struct TokenRingData *simulationData, pthread_t *thrd);
